package status.disabled.onlol.fetcher.api.filler;
...
import status.disabled.onlol.fetcher.api.model.ApiLeagueItemDTO;
import status.disabled.onlol.fetcher.api.model.ApiParticipantIdentityDTO;
import status.disabled.onlol.fetcher.api.model.ApiSummonerDTO;
