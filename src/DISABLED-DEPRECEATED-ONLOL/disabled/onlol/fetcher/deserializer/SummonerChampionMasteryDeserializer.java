...
import status.disabled.onlol.database.repository.ChampionRepository;
import status.disabled.onlol.database.repository.SummonerChampionMasteryLevelRepository;
import status.disabled.onlol.database.repository.SummonerChampionMasteryRepository;
