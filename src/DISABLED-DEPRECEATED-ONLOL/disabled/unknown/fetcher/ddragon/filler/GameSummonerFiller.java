...
import status.disabled.unknown.repository.SummonerProfileImageRepository;
import status.disabled.unknown.repository.SummonerSpellLanguageRepository;
import status.disabled.unknown.repository.SummonerSpellRepository;
