...
import status.disabled.repository.ChampionRepository;
import status.disabled.repository.SummonerChampionMasteryLevelRepository;
import status.disabled.repository.SummonerChampionMasteryRepository;
