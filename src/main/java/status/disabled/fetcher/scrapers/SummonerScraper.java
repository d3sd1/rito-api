package status.disabled.fetcher.scrapers;
...
import status.disabled.fetcher.api.connector.LeaguesConnector;
import status.disabled.fetcher.api.connector.MatchConnector;
import status.disabled.fetcher.api.connector.SummonerConnector;
import status.disabled.fetcher.firstrun.RequiresInitialSetup;
