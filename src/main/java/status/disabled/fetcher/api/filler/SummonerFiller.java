package status.disabled.fetcher.api.filler;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import status.disabled.fetcher.api.ApiConnector;
import status.disabled.fetcher.api.model.ApiLeagueItemDTO;
import status.disabled.fetcher.api.model.ApiParticipantIdentityDTO;
import status.disabled.fetcher.api.model.ApiSummonerDTO;
