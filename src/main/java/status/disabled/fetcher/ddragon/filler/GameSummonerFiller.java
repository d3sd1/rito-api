package status.disabled.fetcher.ddragon.filler;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import status.disabled.fetcher.ddragon.model.DDSummonerImageDTO;
import status.disabled.fetcher.ddragon.model.DDSummonerSpellDTO;
import status.disabled.model.*;
import status.disabled.repository.GameVersionRepository;
import status.disabled.repository.SummonerProfileImageRepository;
import status.disabled.repository.SummonerSpellLanguageRepository;
import status.disabled.repository.SummonerSpellRepository;
