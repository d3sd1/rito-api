...
public class SampleParticipantStats {
    ...
    private Integer perk1; // Primary path keystone rune.
    private Integer perk2; // Primary path keystone rune.
    private Integer perk3; // Primary path keystone rune.
    private Integer perk4; // Secondary path keystone rune.
    private Integer perk5; // Secondary path keystone rune.
